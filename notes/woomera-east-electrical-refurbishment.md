...
I'm standing in front of the PSS switchboard, which is air insulated and modular, where each panel has got a defined function. For this particular project we're dealing with eight panels: seven circuit breakers and one bus VT panel with a bus earthing switch on top of it.
