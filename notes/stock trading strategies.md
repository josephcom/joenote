...
The cause decides most of the result. The signs cannot fix a wrong read of the cause. So spend most of your time here.

These causes usually heal:

- One bad acquisition.
- A systems mess, for example a failed computer system.
- Over-expansion: too many stores or too much stock.
- A scandal about people, not about the product.

These causes usually do not heal:

- A rival or a new technology took the customers.
- The company lost a key contract or a key customer.
- A rule change hurt the business.
- Fraud or strange accounts.
...
- Index change announcements. They give the date when a stock leaves the ASX 200 or the ASX 300.
...
P/E means the price divided by the yearly profit per share. A lower P/E means a cheaper price for the same profit.

The key point is simple. The problem sits in the mood of the market, not in the company. The company sells the same products next year. Only the price changed.
...
- **Weak companies:** Do not buy a weak company only because it fell. The list must hold quality only: low debt, steady profit across ten years, and products that people buy again and again.
- **No cash:** The plan needs cash. Cash earns little in normal years. So decide your cash level in advance, and accept that cost.
...
1. The profit was steady or grew in each of the last ten years.
2. The debt is low.
3. The return on capital is high. (Return on capital is the profit the company makes per dollar it uses.)
4. The customers come back without a push.

Then set a green price for each company. The green price is the price where you will buy. A good green price puts the P/E clearly below the company's own ten-year average.

Watch these panic signs:

- The VIX is above 30. (The VIX is a number that measures fear in the market. Calm markets sit near 15.)
- The index falls 10 percent or more within days.
- The bad news covers every front page.
...
- This strategy carries the lowest risk of the three. So it can carry your biggest positions.
...
Interest rates drive many of these waves. The interest rate is the cost of borrowed money. When rates rise, people buy fewer houses and cars, and these industries suffer. When rates fall, these industries heal.

The strategy has three steps. First, learn which lever moves each industry. Second, wait for the dark phase, when the industry loses money and the share prices are very low. Third, buy near the turn, when the first recovery signs appear.
...
- Interest rates move banks and house builders.
- The oil price moves energy companies.
- Consumer confidence moves cars and travel.
- The inventory cycle moves chip companies. (Inventory is the stock of unsold goods.)

Then watch for early turn signs:

- The central bank starts to cut rates.
- Inventories shrink.
- Weak rivals close plants or go bankrupt.
- Insiders buy across the whole industry, not in one company only.

Useful screens and numbers:

- The price-to-book ratio is near its ten-year low.
- The industry index is down 40 percent or more.
- The PMI turns up. (The PMI is a monthly survey of factories. A value below 50 means the factories shrink.)
