...
**It's all based on trust**! A pension fund can withdraw a two-billion-dollar mandate with a committee vote and a month's notice. No penalty. No lock-in. Nothing to unwind. The asset that generates every dollar of GQG's revenue can leave whenever it likes, for any reason, or no reason at all.
...
**Shop Two ((traditional) active management)** sells traditional stock-picking funds. Not cheap enough to compete with the first, not special enough to compete with the second. This is the shop being hollowed out, which is why these firms keep merging — Franklin buying Legg Mason, Standard Life with Aberdeen, Janus with Henderson. Scale or die. 
